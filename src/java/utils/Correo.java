...
public class Correo {  
    ...
    private String FROM_ADDRESS = "labautomatizacionindustrial@gmail.com";  
    private String PASSWORD = "labindustrial";  
    private String FROM_NAME = "Lab. Automatizacion Industrial";  
