...
<html>
    ...
    <body>
        ...
        <H1> Indicador 2 </H1> 
        promedio: <%=indice.iserv_proceso(2)%> 
         ...
         <H1> Indicador 3 </H1> 
        promedio: <%=indice.iserv_proceso(3)%> 
         ...
         <H1> Indicador 4 </H1> 
        promedio: <%=indice.iserv_proceso(4)%> 
        ...
        <%break;
         ...
         <H1> Indicador 5 </H1> 
        promedio: <%=indice.iserv_proceso(5)%> 
         
         <%break;
         case 6:
             %>
           <H1> Indicador 6 </H1> 
        promedio: <%=indice.iserv_proceso(6)%>    
             
       <%break;
         case 7:
             %>
           <H1> Indicador 7 </H1> 
           promedio: <%=indice.iserv_proceso(7)%> 
