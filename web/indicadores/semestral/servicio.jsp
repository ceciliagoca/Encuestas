...
<!-- mostrar indicadores del semestre-->
 ...
 <table>
     ...
     <tbody>
         <tr> 
             <td> 1 </td> 
             <td class="indicador"> Indicador Meta Objetivos de la calidad <hr>
                Número de preguntas calificadas con 10 u 8 en la  "Encuesta de evaluación"  
             </td> 
 ...
 <table>
     ...
     <tbody>
         ...
         <tr> 
            ...
            <tr> 
             <td> 15 </td> 
             <td class="indicador"> 
         Calificación promedio de la pregunta 10 de la encuesta de  "Evaluación del servicio"
         </td> 
             <td>  </td> <td>  80% </td> 
         </tr>  
     </tbody>    
     ...
     <tbody>
         <tr> 
             <td> 21 </td> 
             <td class="indicador"> Calificación promedio de la pregunta 11 de la "Encuestas de evaluación del servicio"
             </td> 
                  <td><%=indicador.iservicio(10)%> </td> <td>  80% </td> 
         </tr>    
