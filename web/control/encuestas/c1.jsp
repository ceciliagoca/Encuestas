...
<%@page contentType="text/html" pageEncoding="UTF-8"%>
  ...
  <jsp:useBean id="abcEnc" scope="session" class="ABC.ABCEncuestas" />
        ...
        abcEnc.encuesta.addPregunta( request.getParameter("o_11"), "");  
        abcEnc.encuesta.addPregunta( request.getParameter("o_12"), "");  
        abcEnc.encuesta.addPregunta( request.getParameter("o_13"),  "");  
        abcEnc.encuesta.addPregunta( request.getParameter("o_14"), "");  
           
        abcEnc.encuesta.addPregunta((request.getParameter("o_15")==null)?"15":request.getParameter("o_15"),request.getParameter("c_o_15"));
        abcEnc.encuesta.addPregunta( request.getParameter("o_16"),request.getParameter("c_o_16"));
        abcEnc.encuesta.addPregunta( request.getParameter("o_17"),request.getParameter("c_o_17"));
        abcEnc.encuesta.addPregunta( "15", request.getParameter("c_o_18"));
        abcEnc.registrarEncuesta();
